...
const Sidebar = () => {
  ...
  return (
    <div className='w-full lg:h-screen grid gap-0 text-white'>
      <aside
        className="w-[262px] flex-none h-full bg-primary text-white py-[2.375rem] px-0 hidden lg:flex flex-col lg:px-7 gap-8 justify-between"
      >
        <div className='aside-top w-[135px]'>
          ...
          <nav className='mt-10'>
            ...
            >
              ...
              <li>
                <Link to='#' className='w-fit flex items-center gap-2 bg-transparent mr-8'>
                  <img src={Events} alt='' className='w-[1.125rem] mr-1 flex items-center justify-center' />
                  <span className="text-base leading-[120%]">
                    Events
                  </span>
                </Link>
              ...
              <li>
                <Link to='#' className='w-fit flex items-center gap-2 bg-transparent mr-12'>
              ...
              <li>
                <Link to='#' className='w-fit flex items-center gap-2 bg-transparent mr-8 mt-44'>
                  <img src={Sett} alt='' className='w-[1.5rem] mr-1' />
                  <span
                    className="text-base leading-[120%] whitespace-pre"
                  >
                    Settings
                  </span>
                </Link>
              ...
              <li>
                ...
                >
                  <img
                    src={Logout}
                    alt=''
                    className="w-[1.25rem] mr-1"
                  />
                  <span className="text-base leading-[120%] text-error">
                    Logout
                  </span>
                </button>
              </li>
